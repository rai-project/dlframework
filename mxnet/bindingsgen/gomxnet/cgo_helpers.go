...
func (x *MXCallbackList) Free() {
	if x != nil && x.allocs92f982b != nil {
		x.allocs92f982b.(*cgoAllocMap).Free()
		x.ref92f982b = nil
	}
}

// NewMXCallbackListRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewMXCallbackListRef(ref unsafe.Pointer) *MXCallbackList {
	if ref == nil {
		return nil
	}
	obj := new(MXCallbackList)
	obj.ref92f982b = (*C.struct_MXCallbackList)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *MXCallbackList) PassRef() (*C.struct_MXCallbackList, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref92f982b != nil {
		return x.ref92f982b, nil
	}
	mem92f982b := allocStructMXCallbackListMemory(1)
	ref92f982b := (*C.struct_MXCallbackList)(mem92f982b)
	allocs92f982b := new(cgoAllocMap)
	var cnum_callbacks_allocs *cgoAllocMap
	ref92f982b.num_callbacks, cnum_callbacks_allocs = (C.int)(x.NumCallbacks), cgoAllocsUnknown
	allocs92f982b.Borrow(cnum_callbacks_allocs)

	var ccallbacks_allocs *cgoAllocMap
	ref92f982b.callbacks, ccallbacks_allocs = x.Callbacks.PassRef()
	allocs92f982b.Borrow(ccallbacks_allocs)

	var ccontexts_allocs *cgoAllocMap
	ref92f982b.contexts, ccontexts_allocs = (*unsafe.Pointer)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&x.Contexts)).Data)), cgoAllocsUnknown
	allocs92f982b.Borrow(ccontexts_allocs)

	x.ref92f982b = ref92f982b
	x.allocs92f982b = allocs92f982b
	return ref92f982b, allocs92f982b

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x MXCallbackList) PassValue() (C.struct_MXCallbackList, *cgoAllocMap) {
	if x.ref92f982b != nil {
		return *x.ref92f982b, nil
	}
...
func (x *MXCallbackList) Deref() {
	if x.ref92f982b == nil {
		return
	}
	x.NumCallbacks = (int32)(x.ref92f982b.num_callbacks)
	x.Callbacks = NewRef(unsafe.Pointer(x.ref92f982b.callbacks))
	hxff6bc57 := (*sliceHeader)(unsafe.Pointer(&x.Contexts))
	hxff6bc57.Data = uintptr(unsafe.Pointer(x.ref92f982b.contexts))
...
func (x *NDArrayOpInfo) Ref() *C.struct_NDArrayOpInfo {
	...
	return x.ref94c0476e
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *NDArrayOpInfo) Free() {
	if x != nil && x.allocs94c0476e != nil {
		x.allocs94c0476e.(*cgoAllocMap).Free()
		x.ref94c0476e = nil
	}
}

// NewNDArrayOpInfoRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewNDArrayOpInfoRef(ref unsafe.Pointer) *NDArrayOpInfo {
	if ref == nil {
		return nil
	}
	obj := new(NDArrayOpInfo)
	obj.ref94c0476e = (*C.struct_NDArrayOpInfo)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *NDArrayOpInfo) PassRef() (*C.struct_NDArrayOpInfo, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref94c0476e != nil {
		return x.ref94c0476e, nil
	}
	mem94c0476e := allocStructNDArrayOpInfoMemory(1)
	ref94c0476e := (*C.struct_NDArrayOpInfo)(mem94c0476e)
	allocs94c0476e := new(cgoAllocMap)
	var cforward_allocs *cgoAllocMap
	ref94c0476e.forward, cforward_allocs = x.Forward.PassRef()
	allocs94c0476e.Borrow(cforward_allocs)

	var cbackward_allocs *cgoAllocMap
	ref94c0476e.backward, cbackward_allocs = x.Backward.PassRef()
	allocs94c0476e.Borrow(cbackward_allocs)

	var cinfer_shape_allocs *cgoAllocMap
	ref94c0476e.infer_shape, cinfer_shape_allocs = x.InferShape.PassRef()
	allocs94c0476e.Borrow(cinfer_shape_allocs)

	var clist_outputs_allocs *cgoAllocMap
	ref94c0476e.list_outputs, clist_outputs_allocs = x.ListOutputs.PassRef()
	allocs94c0476e.Borrow(clist_outputs_allocs)

	var clist_arguments_allocs *cgoAllocMap
	ref94c0476e.list_arguments, clist_arguments_allocs = x.ListArguments.PassRef()
	allocs94c0476e.Borrow(clist_arguments_allocs)

	var cdeclare_backward_dependency_allocs *cgoAllocMap
	ref94c0476e.declare_backward_dependency, cdeclare_backward_dependency_allocs = x.DeclareBackwardDependency.PassRef()
	allocs94c0476e.Borrow(cdeclare_backward_dependency_allocs)

	var cp_forward_allocs *cgoAllocMap
	ref94c0476e.p_forward, cp_forward_allocs = *(*unsafe.Pointer)(unsafe.Pointer(&x.PForward)), cgoAllocsUnknown
	allocs94c0476e.Borrow(cp_forward_allocs)

	var cp_backward_allocs *cgoAllocMap
	ref94c0476e.p_backward, cp_backward_allocs = *(*unsafe.Pointer)(unsafe.Pointer(&x.PBackward)), cgoAllocsUnknown
	allocs94c0476e.Borrow(cp_backward_allocs)

	var cp_infer_shape_allocs *cgoAllocMap
	ref94c0476e.p_infer_shape, cp_infer_shape_allocs = *(*unsafe.Pointer)(unsafe.Pointer(&x.PInferShape)), cgoAllocsUnknown
	allocs94c0476e.Borrow(cp_infer_shape_allocs)

	var cp_list_outputs_allocs *cgoAllocMap
	ref94c0476e.p_list_outputs, cp_list_outputs_allocs = *(*unsafe.Pointer)(unsafe.Pointer(&x.PListOutputs)), cgoAllocsUnknown
	allocs94c0476e.Borrow(cp_list_outputs_allocs)

	var cp_list_arguments_allocs *cgoAllocMap
	ref94c0476e.p_list_arguments, cp_list_arguments_allocs = *(*unsafe.Pointer)(unsafe.Pointer(&x.PListArguments)), cgoAllocsUnknown
	allocs94c0476e.Borrow(cp_list_arguments_allocs)

	var cp_declare_backward_dependency_allocs *cgoAllocMap
	ref94c0476e.p_declare_backward_dependency, cp_declare_backward_dependency_allocs = *(*unsafe.Pointer)(unsafe.Pointer(&x.PDeclareBackwardDependency)), cgoAllocsUnknown
	allocs94c0476e.Borrow(cp_declare_backward_dependency_allocs)

	x.ref94c0476e = ref94c0476e
	x.allocs94c0476e = allocs94c0476e
	return ref94c0476e, allocs94c0476e

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x NDArrayOpInfo) PassValue() (C.struct_NDArrayOpInfo, *cgoAllocMap) {
	if x.ref94c0476e != nil {
		return *x.ref94c0476e, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *NDArrayOpInfo) Deref() {
	if x.ref94c0476e == nil {
		return
	}
	x.Forward = NewRef(unsafe.Pointer(x.ref94c0476e.forward))
	x.Backward = NewRef(unsafe.Pointer(x.ref94c0476e.backward))
	x.InferShape = NewRef(unsafe.Pointer(x.ref94c0476e.infer_shape))
	x.ListOutputs = NewRef(unsafe.Pointer(x.ref94c0476e.list_outputs))
	x.ListArguments = NewRef(unsafe.Pointer(x.ref94c0476e.list_arguments))
	x.DeclareBackwardDependency = NewRef(unsafe.Pointer(x.ref94c0476e.declare_backward_dependency))
	x.PForward = (unsafe.Pointer)(unsafe.Pointer(x.ref94c0476e.p_forward))
	x.PBackward = (unsafe.Pointer)(unsafe.Pointer(x.ref94c0476e.p_backward))
	x.PInferShape = (unsafe.Pointer)(unsafe.Pointer(x.ref94c0476e.p_infer_shape))
	x.PListOutputs = (unsafe.Pointer)(unsafe.Pointer(x.ref94c0476e.p_list_outputs))
	x.PListArguments = (unsafe.Pointer)(unsafe.Pointer(x.ref94c0476e.p_list_arguments))
	x.PDeclareBackwardDependency = (unsafe.Pointer)(unsafe.Pointer(x.ref94c0476e.p_declare_backward_dependency))
}
...
func packSSByte(v [][]byte, ptr0 **C.char) {
	...
	for i0 := range v {
		...
		hxf1231c9.Data = uintptr(unsafe.Pointer(ptr1))
...
func packSSSUUint32(v [][][]uint32, ptr0 ***C.mx_uint) {
	...
	for i0 := range v {
		...
		for i1 := range v[i0] {
			...
			hxf547023 := (*sliceHeader)(unsafe.Pointer(&v[i0][i1]))
			hxf547023.Data = uintptr(unsafe.Pointer(ptr2))
...
func packSSUUint64(v [][]uint64, ptr0 **C.uint64_t) {
	...
	for i0 := range v {
		...
		hxf44d909.Data = uintptr(unsafe.Pointer(ptr1))
...
func packSSFloat32(v [][]float32, ptr0 **C.mx_float) {
	...
	for i0 := range v {
		...
		hxf458096.Data = uintptr(unsafe.Pointer(ptr1))
