...
func (*Feature) Descriptor() ([]byte, []int) { return fileDescriptorModel, []int{5} }
...
func (*MXNetInferenceResponse) Descriptor() ([]byte, []int) { return fileDescriptorModel, []int{6} }
...
func (*MXNetModelInformationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorModel, []int{7}
}
...
func (*Null) Descriptor() ([]byte, []int) { return fileDescriptorModel, []int{8} }
...
func (m *Feature) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Probability != 0 {
		dAtA[i] = 0x1d
		i++
		i = encodeFixed32Model(dAtA, i, uint32(math.Float32bits(float32(m.Probability))))
	}
	return i, nil
}
...
func NewPopulatedFeature(r randyModel, easy bool) *Feature {
	this := &Feature{}
	this.Index = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.Index *= -1
...
var fileDescriptorModel = []byte{
	...
	,
}
