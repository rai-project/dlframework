...
type Model_Information struct {
	...
	MeanImage   []float32                       `protobuf:"fixed32,12,rep,packed,name=mean_image,json=meanImage" json:"mean_image,omitempty" yaml:"mean_image,omitempty"`
	References  []string                        `protobuf:"bytes,13,rep,name=references" json:"references,omitempty" yaml:"references,omitempty"`
}
...
var fileDescriptorMxnet = []byte{
	...
	,
}
