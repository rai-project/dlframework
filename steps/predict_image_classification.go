...
type predictClassification struct {
	base
	predictor predictor.Predictor
}

func NewPredictImageClassification(predictor predictor.Predictor) pipeline.Step {
	res := predictClassification{
		base: base{
			info: "PredictImageClassification",
		},
	}
...
func (p predictClassification) do(ctx context.Context, in0 interface{}, pipelineOpts *pipeline.Options) interface{} {
...
func (p predictClassification) Close() error {
	return nil
}
