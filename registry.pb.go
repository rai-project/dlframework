...
type Agent struct {
	...
	Metadata     map[string]string `protobuf:"bytes,8,rep,name=metadata" json:"metadata,omitempty" yaml:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func NewPopulatedModelManifestsResponse(r randyRegistry, easy bool) *ModelManifestsResponse {
	...
	if r.Intn(10) != 0 {
		v10 := r.Intn(5)
		this.Manifests = make([]*ModelManifest, v10)
		for i := 0; i < v10; i++ {
...
func randFieldRegistry(dAtA []byte, r randyRegistry, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateRegistry(dAtA, uint64(v12))
	case 1:
		dAtA = encodeVarintPopulateRegistry(dAtA, uint64(key))
...
var fileDescriptorRegistry = []byte{
	...
	,
}
