...
/*GetFrameworkModelManifest swagger:route POST /v1/framework/{framework_name}/{framework_version}/model/{model_name}/{model_version}/info registry getFrameworkModelManifest
