...
func (c *Registry) 	GetModelManifests(ctx context.Context, ignore *Null) (*dlframework.GetModelManifestsResponse, error){
  panic("GetModelManifests")
  return nil , nil
}

func (c *Registry) 	GetFrameworkModelManifest(ctx context.Context, *dlframework.GetFrameworkModelManifestRequest) (*dlframework.ModelManifest, error){
  panic("GetFrameworkModelManifest")
  return nil , nil
}

func (c *Registry) 	GetModelManifest(ctx context.Context, *dlframework.GetModelManifestRequest) (*dlframework.ModelManifest, error){
