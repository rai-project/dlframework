...
func request_Predictor_Dataset_0(ctx context.Context, marshaler runtime.Marshaler, client PredictorClient, req *http.Request, pathParams map[string]string) (Predictor_DatasetClient, runtime.ServerMetadata, error) {
	var protoReq PredictDatasetRequest
	var metadata runtime.ServerMetadata
...
func RegisterRegistryHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("GET", pattern_Registry_FrameworkManifests_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Registry_FrameworkManifests_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_Registry_FrameworkAgents_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Registry_FrameworkAgents_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_Registry_ModelManifests_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Registry_ModelManifests_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_Registry_ModelAgents_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Registry_ModelAgents_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPredictorHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("POST", pattern_Predictor_URLs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Predictor_URLs_0(ctx, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_Predictor_Images_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Predictor_Images_0(ctx, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_Predictor_Dataset_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Predictor_Dataset_0(ctx, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
