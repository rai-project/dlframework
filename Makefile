...
generate-tensorflow:
	...
	go-bindata -nomemcopy -prefix frameworks/tensorflow/builtin_models/ -pkg mxnet -o frameworks/tensorflow/builtin_models_static.go -ignore=.DS_Store  -ignore=README.md frameworks/tensorflow/builtin_models/...
