...
func (o *ImagesStreamURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/predict/stream/images"
...
func (o *ImagesStreamURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ImagesStreamURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ImagesStreamURL")
	}
