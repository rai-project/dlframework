...
func (o *DatasetStreamURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/predict/stream/dataset"
...
func (o *DatasetStreamURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DatasetStreamURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DatasetStreamURL")
	}
